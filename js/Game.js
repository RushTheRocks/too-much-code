class Game {
        ...
        else if(passedFinsihed===false){yVel*=0.7;
        xVel*=0.7;
          ...
          drawSprites();
           ...
           displayRanks(){
            ...
            image(goldImage,0,-100,250,300)
             image(silverImage,displayWidth/4,-100+displayHeight/10,255,270)
             image(bronzeImage,displayWidth/-4,-100+displayHeight/9,200,240)
             textAlign(CENTER)
             textSize=50
             for(var plr in AllPlayers){
                if(allPlayers[plr].place===1){text("first 1st"+allPlayers[plr].name,0,85)}
             }
           }
